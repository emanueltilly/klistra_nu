...
<p>When you visit our website, we collect information such as your IP address, browser type, operating system, and other similar technical details. This information is used to analyze and improve the performance of our website. We do not collect any personally identifiable information unless you choose to provide it to us.</p>

<p>If you decide to use our website to paste and share text, we will collect the text you enter and store it on our servers. We do not require any personal information to use this service. However, if you choose to password protect your text, we will ask you to provide a password that will be used to encrypt your data.</p>
...
<p>Our website may contain links to third-party websites. We are not responsible for the privacy practices or the content of these websites. We encourage you to review the privacy policies of these websites before providing them with any personal information. We are also not responsible for the privacy practices or actions of any third-party site, extension, service, script, or anything else that you may interact with while using our website.</p>

<h4>Changes to this Privacy Policy</h4>

<p>We reserve the right to modify this privacy policy at any time. Any changes we make will be posted on our website, and we encourage you to review this policy periodically.</p>
<br>
</div>